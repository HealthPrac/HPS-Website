      ...
      >
        <div className="dropdown-inner">
          ...
          <div className="dropdown-grid">
            ...
            <button className="dd-item" onClick={() => go("demo")}>
              <span className="num">04</span>
              <span>
                <span className="name">Explore the Platform</span>
                <span className="blurb">Live interactive demo — all 20 modules, real workflows.</span>
              </span>
            </button>
          </div>
        </div>
...
function App() {
  ...
  // Demo page gets full-screen treatment — hide nav/footer
  if (route.name === "demo") {
